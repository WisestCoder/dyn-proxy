...
function printLog(content, type) {
  ...
  switch (type) {
    case LogLevelMap.tip: {
      ...
      console.log(color.cyan(`[DynProxy Log][${timeString}]: ` + content));
      break;
    }
    ...
    case LogLevelMap.system_error: {
      ...
      console.error(color.red(`[DynProxy ERROR][${timeString}]: ` + content));
      break;
    }
    ...
    case LogLevelMap.rule_error: {
      ...
      console.error(color.red(`[DynProxy RULE_ERROR][${timeString}]: ` + content));
      break;
    }
    ...
    case LogLevelMap.warn: {
      ...
      console.error(color.yellow(`[DynProxy WARN][${timeString}]: ` + content));
      break;
    }
